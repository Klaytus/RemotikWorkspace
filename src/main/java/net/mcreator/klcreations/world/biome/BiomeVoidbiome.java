...
package net.mcreator.klcreations.world.biome;
...
public class BiomeVoidbiome extends ElementsDimensionAdditions.ModElement {
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == BlockVoidmatter2.block.getDefaultState().getBlock()
							|| ground == BlockVoidmatter.block.getDefaultState().getBlock())
							&& (ground2 == BlockVoidmatter2.block.getDefaultState().getBlock()
									|| ground2 == BlockVoidmatter.block.getDefaultState().getBlock())))
						return false;
					IBlockState state = world.getBlockState(position.down());
					if (position.getY() < world.getHeight() - height - 1) {
						world.setBlockState(position.down(), BlockVoidmatter.block.getDefaultState(), 2);
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getBlock().isLeaves(state, world, blockpos)
												...
												|| state.getBlock() == BlockVoidFoliage.block.getDefaultState().getBlock()) {
											this.setBlockAndNotifyAdequately(world, blockpos, BlockVoidFoliage.block.getDefaultState());
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							if (state.getBlock().isAir(state, world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock()
									|| state.getBlock() == BlockVoidFoliage.block.getDefaultState().getBlock()) {
								this.setBlockAndNotifyAdequately(world, position.up(genh), BlockVoidlog.block.getDefaultState());
							}
						}
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == BlockVoidlog.block.getDefaultState().getBlock()
					|| blockType == BlockVoidFoliage.block.getDefaultState().getBlock()
					|| blockType == BlockVoidmatter2.block.getDefaultState().getBlock()
					|| blockType == BlockVoidmatter.block.getDefaultState().getBlock();
		}

		@Override
		protected void setDirtAt(World world, BlockPos pos) {
			if (world.getBlockState(pos).getBlock() != BlockVoidmatter.block.getDefaultState().getBlock())
				this.setBlockAndNotifyAdequately(world, pos, BlockVoidmatter.block.getDefaultState());
		}
