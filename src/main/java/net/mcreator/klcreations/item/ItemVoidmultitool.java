...
public class ItemVoidmultitool extends ElementsDimensionAdditions.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("voidmultitool").setRegistryName("voidmultitool").setCreativeTab(TabKleyzAdditionsTab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("klcreations:voidmultitool", "inventory"));
	}
		...
		public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
			...
			if (equipmentSlot == EntityEquipmentSlot.MAINHAND) {
				...
				multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(),
						new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", -2.5999999999999999, 0));
			}
			return multimap;
		}
